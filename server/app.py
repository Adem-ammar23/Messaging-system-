...
AUTH_CHALLENGES = {}   # user -> {"challenge": str, "ts": float}
AUTH_OK = set()     
CHALLENGE_TTL = 60
...
# pwhash_argon2id_32(pass, pass_len, salt16, out32)
...
# Initialize libsodium once at startup.
# Return value: 0 or 1 means success, -1 means failure.
...
def sign_msg():
    ...
    # msg is base64 of arbitrary bytes
...
def auth_prove(user):
    ...
    # verify using our generic endpoint logic directly (no HTTP call)
...
def post_mailbox(user):
    ...
    # Required for ALL messages in Milestone 6
    ...
    # Init messages also require X3DH header fields
